      ...
      scope.runReport = function (){
        ...
        switch(scope.reportType)
        {
          ...
          case "Pentaho":
            ...
            scope.baseURL = "https://localhos:7070/obsplatform/api/v1/runreports/" + encodeURIComponent(scope.reportName); 
            scope.baseURL += "?&tenantIdentifier=default&exportPDF=true";
